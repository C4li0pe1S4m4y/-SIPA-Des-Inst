                ...
                <ContentTemplate>
                    <table style="width:80%;">
                        <tr>
                            <td style="width:5%;">&nbsp;</td>
                            <td style="width:5%;">&nbsp;</td>
                            <td style="font-size: x-large;" class="text-center" colspan="12"><strong>PLAN OPERATIVO</strong></td>
                            <td colspan="2"><strong>
                                <asp:Label ID="lblIdPoa" runat="server" style="font-size: small"></asp:Label>
                                </strong></td>
                        </tr>
                        <tr>
                            <td style="width:5%;">&nbsp;</td>
                            <td style="width:5%;">&nbsp;</td>
                            <td class="text-center" colspan="12" style="font-size: xx-small;"><strong>
                        ...
                        <tr>
                            <td style="width:5%;">&nbsp;</td>
                            <td colspan="5">
                                <asp:DropDownList ID="ddlPlanes" runat="server" AutoPostBack="True" class="form-control" OnSelectedIndexChanged="ddlPlanes_SelectedIndexChanged" Width="100%">
                                </asp:DropDownList>
                            </td>
                            <td colspan="9">&nbsp;</td>
                            <td style="width:5%;">&nbsp;</td>
                        ...
                        <tr>
                            ...
                            <td>&nbsp;</td>
                            <td colspan="9">Unidad Administrativa:<asp:Label ID="lblEUnidad" runat="server" Font-Bold="True" Font-Size="Large" ForeColor="Red"></asp:Label>
                            </td>
                            <td style="width:5%;">&nbsp;</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="width:5%;">&nbsp;</td>
                            <td style="width:5%;">&nbsp;</td>
                            <td class="text-center" colspan="7">REGISTRO</td>
                            <td style="width:5%;">&nbsp;</td>
                            <td style="width:5%;">&nbsp;</td>
                            <td style="width:5%;">&nbsp;</td>
                            <td style="width:5%;">&nbsp;</td>
                        ...
                        <tr>
                            ...
                            <td style="width:5%;">&nbsp;</td>
                            <td style="width:5%;">&nbsp;</td>
                            <td class="text-center" colspan="7" style="font-size: large;"><strong>CUADRO DE MANDO INTEGRAL</strong></td>
                            <td style="width:5%;">&nbsp;</td>
                            <td style="width:5%;">&nbsp;</td>
                            <td style="width:5%;">&nbsp;</td>
                            <td style="width:5%;">&nbsp;</td>
                        ...
                        <tr>
                            <td style="width:5%;">&nbsp;</td>
                            <td colspan="4">Del proceso:<asp:Label ID="lblEProceso" runat="server" Font-Size="Large" ForeColor="Red" Font-Bold="True"></asp:Label>
                            </td>
                            <td>&nbsp;</td>
                            <td>&nbsp;</td>
                            <td>&nbsp;</td>
                        ...
                        <tr>
                            <td style="width:5%;">&nbsp;</td>
                            <td colspan="5">Ejes Estratégicos:<asp:Label ID="lblEEje" runat="server" Font-Size="Large" ForeColor="Red" Font-Bold="True"></asp:Label>
                            </td>
                            <td colspan="6">Objetivos Estratégicos:<asp:Label ID="lblEOEstr" runat="server" Font-Size="Large" ForeColor="Red" Font-Bold="True"></asp:Label>
                            </td>
                            <td style="width:5%;">&nbsp;</td>
                            <td style="width:5%;">&nbsp;</td>
                            <td style="width:5%;">&nbsp;</td>
                        ...
                        <tr>
                            <td style="width:5%;">&nbsp;</td>
                            <td colspan="5">
                                <asp:DropDownList ID="ddlEjes" runat="server" AutoPostBack="True" class="form-control" Width="100%" OnSelectedIndexChanged="ddlEjes_SelectedIndexChanged">
                                </asp:DropDownList>
                            </td>
                            <td colspan="8">
                                <asp:DropDownList ID="ddlObjetivosE" runat="server" AutoPostBack="True" class="form-control" Width="100%" OnSelectedIndexChanged="ddlObjetivosE_SelectedIndexChanged">
                                </asp:DropDownList>
                            </td>
                            <td>&nbsp;</td>
                            <td style="width:5%;">&nbsp;</td>
                        ...
                        <tr>
                            <td style="width:5%;">&nbsp;</td>
                            <td colspan="15">
                                <asp:GridView ID="gridPlanE" runat="server" AllowPaging="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" CellPadding="5" CellSpacing="1" DataKeyNames="ID" ForeColor="Black" GridLines="Vertical" HorizontalAlign="Center" OnPageIndexChanging="gridPlanE_PageIndexChanging" OnSelectedIndexChanged="gridPlanE_SelectedIndexChanged" PageSize="3" Width="95%">
                                    <AlternatingRowStyle BackColor="#CEEFFF" ForeColor="#333333" />
                                    <Columns>
                                        <asp:CommandField HeaderText="Seleccionar" ShowSelectButton="True">
                                        <HeaderStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                        ...
                        <tr>
                            <td style="width:5%;">&nbsp;</td>
                            <td colspan="2"><asp:RequiredFieldValidator ID="rfvCodigo" runat="server" ControlToValidate="txtCodigo" ErrorMessage="*" Font-Bold="True" Font-Size="Large" ForeColor="Red" ValidationGroup="grpDatos"></asp:RequiredFieldValidator>
                            </td>
                            <td colspan="3">Objetivo Operativo:<asp:RequiredFieldValidator ID="rfvObjetivo" runat="server" ControlToValidate="txtObjetivo" ErrorMessage="*" Font-Bold="True" Font-Size="Large" ForeColor="Red" ValidationGroup="grpDatos"></asp:RequiredFieldValidator>
                            </td>
                            <td>&nbsp;</td>
                            <td colspan="3">Indicador:<asp:RequiredFieldValidator ID="rfvIndicador" runat="server" ControlToValidate="txtIndicador" ErrorMessage="*" Font-Bold="True" Font-Size="Large" ForeColor="Red" ValidationGroup="grpDatos"></asp:RequiredFieldValidator>
                            </td>
                            <td>&nbsp;</td>
                            <td colspan="3">Meta:<asp:RequiredFieldValidator ID="rfvMeta" runat="server" ControlToValidate="txtMeta" ErrorMessage="*" Font-Bold="True" Font-Size="Large" ForeColor="Red" ValidationGroup="grpDatos"></asp:RequiredFieldValidator>
                            </td>
                            <td>&nbsp;</td>
                            <td style="width:5%;">&nbsp;</td>
                        </tr>
                        <tr>
                            <td style="width:5%;">&nbsp;</td>
                            <td colspan="2">
                                <asp:TextBox ID="txtCodigo" runat="server" class="form-control" Font-Bold="True" Font-Size="XX-Large" MaxLength="2" Width="100%" Visible="False"></asp:TextBox>
                            </td>
                        ...
                        <tr>
                            ...
                            <td colspan="11">
                                ...
                                <asp:Button ID="btnNuevaB" runat="server" CausesValidation="False" class="btn btn-primary" OnClick="btnNuevaB_Click" Text="Buscar" Width="120px" Visible="False" />
