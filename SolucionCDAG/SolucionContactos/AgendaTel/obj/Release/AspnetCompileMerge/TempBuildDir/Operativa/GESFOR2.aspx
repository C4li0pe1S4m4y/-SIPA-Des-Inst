<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GESFOR2.aspx.cs" Inherits="AplicacionSIPA1.Operativa.GESFOR2" MasterPageFile="~/Principal.Master" %>
                ...
                <ContentTemplate>
                    ...
                    <table style="width:90%;">
                        ...
                        <tr>
                            ...
                            <td style="width: 5%">&nbsp;</td>
                            <td colspan="4" style="border: 1px solid #000000;">
                                <asp:TextBox ID="txtObjetivo0" runat="server" class="form-control" Height="150px" MaxLength="500" placeholder="Escriba aquí el nuevo Objetivo" TextMode="MultiLine" Width="100%"></asp:TextBox>
                            </td>
                            <td colspan="4" style="border: 1px solid #000000;">
                                <asp:TextBox ID="txtIndicador0" runat="server" class="form-control" Height="150px" MaxLength="500" placeholder="Escriba aquí el nuevo Indicador/Kpi" TextMode="MultiLine" Width="100%"></asp:TextBox>
                            </td>
                            <td colspan="4" style="border: 1px solid #000000;">
                                <asp:TextBox ID="txtMetaO0" runat="server" class="form-control" Height="150px" MaxLength="500" placeholder="Escriba aquí el nuevo Meta Operativa" TextMode="MultiLine" Width="100%"></asp:TextBox>
                            </td>
                            <td colspan="4" style="border: 1px solid #000000;">
                                <asp:TextBox ID="txtAccion0" runat="server" class="form-control" Height="150px" MaxLength="250" placeholder="Escriba aquí la nueva Acción" TextMode="MultiLine" Width="100%"></asp:TextBox>
                            </td>
                            <td style="width: 5%">&nbsp;</td>
                            <td style="width: 5%">&nbsp;</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td colspan="16">
                                <asp:Panel ID="pnlDetAccion" runat="server" Height="465px">
                                    ...
                                    <tr>
                                        <td style="border: 1px solid #000000; width: 25%">
                                            <asp:TextBox ID="txtMetaM" runat="server" class="form-control" Height="150px" MaxLength="250" placeholder="Escriba aquí la nueva Meta" TextMode="MultiLine" Width="100%"></asp:TextBox>
                                        </td>
                                        <td style="border: 1px solid #000000; width: 25%">
                                            <asp:TextBox ID="txtMetaM1" runat="server" class="form-control" Height="150px" MaxLength="250" placeholder="Escriba aquí la nueva Meta" TextMode="MultiLine" Width="100%"></asp:TextBox>
                                        </td>
                                        <td style="border: 1px solid #000000; width: 25%">
                                            <asp:TextBox ID="txtMetaM2" runat="server" class="form-control" Height="150px" MaxLength="250" placeholder="Escriba aquí la nueva Meta" TextMode="MultiLine" Width="100%"></asp:TextBox>
                                        </td>
                                        <td style="border: 1px solid #000000; width: 25%">
                                            <asp:TextBox ID="txtMetaM3" runat="server" class="form-control" Height="150px" MaxLength="250" placeholder="Escriba aquí la nueva Meta" TextMode="MultiLine" Width="100%"></asp:TextBox>
                                        </td>
                                    </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td style="border: 1px solid #000000; width: 25%">
                                                <asp:TextBox ID="txtPond1" runat="server" class="form-control" MaxLength="3" placeholder="Ponderación" TextMode="Number" Width="100%"></asp:TextBox>
                                            </td>
                                            <td style="border: 1px solid #000000; width: 25%">
                                                <asp:TextBox ID="txtPond2" runat="server" class="form-control" MaxLength="3" placeholder="Ponderación" TextMode="Number" Width="100%"></asp:TextBox>
                                            </td>
                                            <td style="border: 1px solid #000000; width: 25%">
                                                <asp:TextBox ID="txtPond3" runat="server" class="form-control" MaxLength="3" placeholder="Ponderación" TextMode="Number" Width="100%"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                        ...
                        <tr>
                            ...
                            <td colspan="4" style="text-align: center; border: 1px solid #000000"><b>Presupuesto actual <strong>(Q.)</strong></b></td>
                            ...
                            <td colspan="4" style="text-align: center; border: 1px solid #000000"><strong><b>
                                <asp:Label ID="lblS1" runat="server" Font-Bold="True" Font-Size="X-Large" ForeColor="Red">(-)</asp:Label>
                                &nbsp;</b>Monto a modificar&nbsp;(Q.)<asp:RequiredFieldValidator ID="rfvPresupuesto" runat="server" ControlToValidate="txtPpto1" ErrorMessage="*" Font-Bold="True" Font-Size="Large" ForeColor="Red" ValidationGroup="grpDatos"></asp:RequiredFieldValidator>
                                </strong></td>
                            <td colspan="4" style="text-align: center; border: 1px solid #000000"><strong>Monto total modificado</b></b> (Q.)</strong></td>
                            <td style="width: 5%">&nbsp;</td>
                            <td style="width: 5%">&nbsp;</td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="4" style="border: 1px solid #000000" class="text-right">
                                <asp:Label ID="lblPpto1" runat="server" Font-Bold="False" Font-Size="Large"></asp:Label>
                            </td>
                            <td colspan="4" style="border: 1px solid #000000" class="text-right">
                                <asp:TextBox ID="txtPpto1" runat="server" Style="text-align: right" class="form-control" MaxLength="20" ToolTip="Debe ser menor al presupuesto disponible" Width="100%" Font-Size="Large">100, 000, 000.00</asp:TextBox>
                            </td>
                            <td colspan="4" style="border: 1px solid #000000" class="text-right">
                                <asp:Label ID="lblPptoM1" runat="server" Font-Bold="False" Font-Size="Large"></asp:Label>
                            </td>
                            <td style="width: 5%">&nbsp;</td>
                            <td style="width: 5%">&nbsp;</td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="4">&nbsp;</td>
                            <td colspan="4">
                                <asp:RangeValidator ID="rvPresupuesto" runat="server" ControlToValidate="txtPpto1" ErrorMessage="Entre 0 y el disponible" Font-Bold="True" ForeColor="Red" MaximumValue="100000000" MinimumValue="0" Type="Double" ValidationGroup="grpDatos"></asp:RangeValidator>
                            </td>
                            <td colspan="4">&nbsp;</td>
                            <td style="width: 5%">&nbsp;</td>
                            <td style="width: 5%">&nbsp;</td>
                        ...
                        <tr>
                            ...
                            <td style="border: 1px solid #000000; width: 5%">
                                <asp:TextBox ID="txtM1" runat="server" class="form-control" Font-Bold="True" MaxLength="1" Width="100%"></asp:TextBox>
                            </td>
                            <td style="border: 1px solid #000000; width: 5%">
                                <asp:TextBox ID="txtM2" runat="server" class="form-control" Font-Bold="True" MaxLength="1" Width="100%"></asp:TextBox>
                            </td>
                            <td colspan="2" style="border: 1px solid #000000; width: 5%">
                                <asp:TextBox ID="txtM3" runat="server" class="form-control" Font-Bold="True" MaxLength="1" Width="100%"></asp:TextBox>
                            </td>
                            <td style="border: 1px solid #000000; width: 5%">
                                <asp:TextBox ID="txtM4" runat="server" class="form-control" Font-Bold="True" MaxLength="1" Width="100%"></asp:TextBox>
                            </td>
                            <td style="border: 1px solid #000000; width: 5%">
                                <asp:TextBox ID="txtM5" runat="server" class="form-control" Font-Bold="True" MaxLength="1" Width="100%"></asp:TextBox>
                            </td>
                            <td style="border: 1px solid #000000; width: 5%">
                                <asp:TextBox ID="txtM6" runat="server" class="form-control" Font-Bold="True" MaxLength="1" Width="100%"></asp:TextBox>
                            </td>
                            <td style="border: 1px solid #000000; width: 5%">
                                <asp:TextBox ID="txtM7" runat="server" class="form-control" Font-Bold="True" MaxLength="1" Width="100%"></asp:TextBox>
                            </td>
                            <td style="border: 1px solid #000000; width: 5%">
                                <asp:TextBox ID="txtM8" runat="server" class="form-control" Font-Bold="True" MaxLength="1" Width="100%"></asp:TextBox>
                            </td>
                            <td style="border: 1px solid #000000; width: 5%">
                                <asp:TextBox ID="txtM9" runat="server" class="form-control" Font-Bold="True" MaxLength="1" Width="100%"></asp:TextBox>
                            </td>
                            <td colspan="2" style="border: 1px solid #000000; width: 5%">
                                <asp:TextBox ID="txtM10" runat="server" class="form-control" Font-Bold="True" MaxLength="1" Width="100%"></asp:TextBox>
                            </td>
                            <td style="border: 1px solid #000000; width: 5%">
                                <asp:TextBox ID="txtM11" runat="server" class="form-control" Font-Bold="True" MaxLength="1" Width="100%"></asp:TextBox>
                            </td>
                            <td style="border: 1px solid #000000; width: 5%">
                                <asp:TextBox ID="txtM12" runat="server" class="form-control" Font-Bold="True" MaxLength="1" Width="100%"></asp:TextBox>
                            </td>
                            <td style="width: 5%">&nbsp;</td>
                            <td style="width: 5%">&nbsp;</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="text-left" colspan="6">
                                MODIFICACIÓN DE PRESUPUESTO</td>
                            <td colspan="5">
                                <asp:RadioButtonList ID="rblModPpto" runat="server" OnSelectedIndexChanged="rblModPpto_SelectedIndexChanged" RepeatDirection="Horizontal" Width="90%" AutoPostBack="True">
                        ...
                        <tr>
                            <td style="width: 5%">&nbsp;</td>
                            <td style="width: 5%">&nbsp;</td>
                            <td style="border: 1px solid #000000; text-align: center;" colspan="4" class="text-right"><strong>Acción<asp:Label ID="lblEAccion2" runat="server" Font-Bold="True" Font-Size="Large" ForeColor="Red">*</asp:Label>
                                </strong></td>
                            <td colspan="4" style="border: 1px solid #000000; text-align: center;" class="text-right"><strong>Presupuesto actual (Q.)</strong></td>
                            <td colspan="4" style="border: 1px solid #000000; text-align: center;" class="text-right"><strong><b>
                                <asp:Label ID="lblS2" runat="server" Font-Bold="True" Font-Size="X-Large" ForeColor="Red">(+)</asp:Label>
                                &nbsp;</b>Monto a modificar (Q.)<asp:RequiredFieldValidator ID="rfvPresupuesto2" runat="server" ControlToValidate="txtPpto2" ErrorMessage="*" Font-Bold="True" Font-Size="Large" ForeColor="Red" ValidationGroup="grpDatos"></asp:RequiredFieldValidator>
                                </strong></td>
                            <td colspan="4" style="border: 1px solid #000000; text-align: center;" class="text-right"><strong>Monto total modificado (Q.)</strong></td>
                            <td style="width: 5%">&nbsp;</td>
                            <td style="width: 5%">&nbsp;</td>
                        </tr>
                        <tr>
                            ...
                            <td style="width: 5%">&nbsp;</td>
                            <td colspan="4" style="border: 1px solid #000000;">
                                <asp:DropDownList ID="ddlAcciones2" runat="server" AutoPostBack="True" class="form-control" OnSelectedIndexChanged="ddlAcciones2_SelectedIndexChanged" Width="100%">
                                </asp:DropDownList>
                            </td>
                            <td colspan="4" style="border: 1px solid #000000;" class="text-right">
                                <asp:Label ID="lblPpto2" runat="server" Font-Bold="False" Font-Size="Large"></asp:Label>
                            </td>
                            <td colspan="4" style="border: 1px solid #000000;">
                                <asp:TextBox ID="txtPpto2" runat="server" class="form-control" Font-Size="Large" MaxLength="20" Style="text-align: right" ToolTip="Debe ser menor al presupuesto disponible" Width="100%">100, 000, 000.00</asp:TextBox>
                            </td>
                            <td colspan="4" style="border: 1px solid #000000;" class="text-right">
                                <asp:Label ID="lblPptoM2" runat="server" Font-Bold="False" Font-Size="Large"></asp:Label>
                            </td>
                            <td style="width: 5%">&nbsp;</td>
                            <td style="width: 5%">&nbsp;</td>
                        </tr>
                        <tr>
                            ...
                            <td class="text-right" colspan="4" style="border-top: 1px solid #000000;">&nbsp;</td>
                            <td colspan="4" style="border-top: 1px solid #000000;"><asp:RangeValidator ID="rvPresupuesto0" runat="server" ControlToValidate="txtPpto2" ErrorMessage="Entre 0 y el disponible" Font-Bold="True" ForeColor="Red" MaximumValue="100000000" MinimumValue="0" ValidationGroup="grpDatos"></asp:RangeValidator>
                                </td>
                            <td class="text-right" colspan="4" style="border-top: 1px solid #000000;">&nbsp;</td>
                            <td style="width: 5%">&nbsp;</td>
                            <td style="width: 5%">&nbsp;</td>
                        ...
                        <tr>
                            ...
                            <td style="border-left: 1px solid #000000; border-right: 1px solid #000000; border-bottom: 1px solid #000000;" colspan="16">
                                <asp:TextBox ID="txtJustificacion" runat="server" class="form-control" Height="100px" MaxLength="1000" placeholder="Justificación" TextMode="MultiLine" Width="100%" Font-Size="Small"></asp:TextBox>
                            </td>
                            <td style="width: 5%">&nbsp;</td>
                            <td style="width: 5%">&nbsp;</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td colspan="16" style="text-align: center;">
                                ...
                                <asp:Button ID="btnListado" runat="server" class="btn btn-default" Text="Listado" Width="120px" />
