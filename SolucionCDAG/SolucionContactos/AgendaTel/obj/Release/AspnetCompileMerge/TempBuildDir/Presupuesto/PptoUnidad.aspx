...
<asp:Content ID="Content1" runat="server" contentplaceholderid="ContentPlaceHolder3">
                ...
                <tr>
                    ...
                    <td class="auto-style4">
                        ...
                        <asp:RangeValidator ID="RangeValidator1" runat="server" ControlToValidate="txtMonto" ErrorMessage="* Ingrese un valor numérico" Font-Bold="True" ForeColor="Red" MaximumValue="300000000" MinimumValue="1" Type="Double"></asp:RangeValidator>
                    </td>
                    <td class="auto-style12">&nbsp;</td>
                    <td>
                        &nbsp;</td>
