<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NoPlan.aspx.cs" Inherits="AplicacionSIPA1.Pac.NoPlan" %>
...
&nbsp;con Exito, por un Monto de:
        ...
        <p>
            <asp:HyperLink ID="HyperLink3" runat="server" Font-Size="X-Large" Font-Underline="True" NavigateUrl="~/Pac/ListadoPlan.aspx">Ver Listado</asp:HyperLink>
        </p>
        <p>
            <asp:HyperLink ID="HyperLink1" runat="server" Font-Overline="False" Font-Size="X-Large" Font-Underline="True" NavigateUrl="~/Pac/IngresarPac.aspx">Crear Nuevo</asp:HyperLink>
        </p>
        <p>
            &nbsp;</p>
