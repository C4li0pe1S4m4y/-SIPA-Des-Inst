        ...
        <ContentTemplate>
            ...
            <table style="width:100%;">
                <tr>
                    <td style="width: 5%">&nbsp;</td>
                    <td style="width: 5%">&nbsp;</td>
                    <td style="font-size: x-large;" class="text-center" colspan="9"><strong>CMI - APROBACIÓN DIRECCIÓN DE ESTRATEGIA</strong></td>
                    <td style="width: 5%">&nbsp;</td>
                ...
                <tr>
                    ...
                    <td colspan="6">
                        <asp:DropDownList ID="ddlDependencias" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlDependencias_SelectedIndexChanged" Width="100%" Visible="False">
                        </asp:DropDownList>
                    </td>
...
<tr>
                ...
                <tr>
                    ...
                    <td class="text-center" colspan="6">
                        ...
                        <asp:Button ID="btnCodificar" runat="server" class="btn btn-default" OnClick="btnCodificar_Click" Text="Codificar" ValidationGroup="grpDatos" Width="120px" />
                    </td>
                    <td style="width: 5%">&nbsp;</td>
                    <td style="width: 5%">&nbsp;</td>
                    <td style="width: 5%">&nbsp;</td>
