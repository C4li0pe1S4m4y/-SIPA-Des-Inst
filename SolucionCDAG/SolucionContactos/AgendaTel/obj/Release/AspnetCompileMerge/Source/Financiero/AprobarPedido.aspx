<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AprobarPedido.aspx.cs" Inherits="AplicacionSIPA1.Financiero.AprobarPedido" MasterPageFile="~/Principal.Master" %>
            ...
            <table style="width:100%;">
                    ...
                    <td colspan="6"><asp:GridView ID="gridDetalle" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" CellPadding="5" CellSpacing="1" DataKeyNames="ID" ForeColor="Black" GridLines="Vertical" HorizontalAlign="Left" PageSize="5" ShowFooter="True" Width="75%" OnRowDataBound="gridDetalle_RowDataBound" OnSelectedIndexChanged="gridDetalle_SelectedIndexChanged">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Reglon">
                                    ...
                                    <ItemTemplate>
                                        <asp:DropDownList ID="dropReglon" runat="server" AutoPostBack="True" OnSelectedIndexChanged="dropReglon_SelectedIndexChanged">
                                        </asp:DropDownList>
                                    </ItemTemplate>
                                    <HeaderStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                    <ItemStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Pro">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox4" runat="server"></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:DropDownList ID="dropPro" runat="server" AutoPostBack="True" OnSelectedIndexChanged="dropPro_SelectedIndexChanged">
                                            <asp:ListItem Value="0">Pro</asp:ListItem>
                                ...
                                <asp:TemplateField HeaderText="Spro">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox3" runat="server"></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:DropDownList ID="dropSpro" runat="server" AutoPostBack="True" OnSelectedIndexChanged="dropSpro_SelectedIndexChanged">
                                            <asp:ListItem Value="0">Spr</asp:ListItem>
                                            <asp:ListItem>01</asp:ListItem>
                                ...
                                <asp:TemplateField HeaderText="Act">
                                    ...
                                    <ItemTemplate>
                                        <asp:DropDownList ID="dropAct" runat="server" AutoPostBack="True" OnSelectedIndexChanged="dropAct_SelectedIndexChanged">
                                            <asp:ListItem Value="0">Act</asp:ListItem>
                                            <asp:ListItem>01</asp:ListItem>
                                            <asp:ListItem>02</asp:ListItem>
                                            <asp:ListItem>03</asp:ListItem>
                                            <asp:ListItem>04</asp:ListItem>
                ...
                <tr>
                    ...
                    <td colspan="4">
                        ...
                        <asp:TextBox ID="txtMensaje" runat="server" class="form-control" MaxLength="300" placeholder="Mensaje de Rechazo" Width="80%" OnTextChanged="txtMensaje_TextChanged"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                ...
                <tr>
                    <td colspan="6">
                        <asp:GridView ID="gridSaldos" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" CellPadding="5" CellSpacing="1" DataKeyNames="ID" ForeColor="Black" GridLines="Vertical" HorizontalAlign="Center" Width="95%" OnSelectedIndexChanged="gridSaldos_SelectedIndexChanged">
                            <AlternatingRowStyle BackColor="#CEEFFF" ForeColor="#333333" />
                            <Columns>
                                <asp:BoundField DataField="ID" HeaderText="ID">
                                <HeaderStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
