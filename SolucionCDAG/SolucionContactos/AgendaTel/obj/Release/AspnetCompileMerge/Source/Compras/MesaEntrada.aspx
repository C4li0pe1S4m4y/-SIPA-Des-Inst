<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MesaEntrada.aspx.cs" Inherits="AplicacionSIPA1.Compras.MesaEntrada" MasterPageFile="~/Principal.Master" %>
...
<asp:Content ID="Content1" runat="server" contentplaceholderid="ContentPlaceHolder3">
            ...
            <table style="width:100%;">
                ...
                <tr>
                    <td>
                        <asp:Button ID="btnAprobar" runat="server" BackColor="#3366CC" class="btn btn-primary" Font-Bold="True" OnClick="btnAprobar_Click" Text="Ingresar" Width="99%" />
                    </td>
                    <td>
                        <asp:Button ID="btnRechazar" runat="server" BackColor="#FF3300" class="btn btn-primary" Font-Bold="True" OnClick="btnRechazar_Click" onclientclick="javascript:if(!confirm('¿Desea Rechazar el Pedido?'))return false" Text="Rechazar" Width="99%" />
                    </td>
                    <td colspan="4">
