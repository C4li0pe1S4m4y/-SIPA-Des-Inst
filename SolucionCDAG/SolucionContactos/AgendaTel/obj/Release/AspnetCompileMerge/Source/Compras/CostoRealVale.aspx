<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CostoRealVale.aspx.cs" Inherits="AplicacionSIPA1.Compras.CostoRealVale" MasterPageFile="~/Principal.Master" %>
<asp:Content ID="Content1" runat="server" contentplaceholderid="ContentPlaceHolder3">
    <link href="../css/chosen.css" rel="stylesheet" type="text/css" media="screen" />             
            ...
            <table style="width:100%;">
                <tr>
                    <td><asp:DetailsView ID="dvPedido" runat="server" AutoGenerateRows="False" DataKeyNames="ID" Width="75%" AllowPaging="True" OnPageIndexChanging="dvPedido_PageIndexChanging">
