...
<asp:Content ID="Content1" runat="server" contentplaceholderid="ContentPlaceHolder3">
                ...
                <tr>
                    ...
                    <td class="auto-style4">
                        <asp:DropDownList ID="dropEmpleado" runat="server" class="form-control">
                        </asp:DropDownList>
                    </td>
                ...
                <tr>
                    <td class="auto-style3">&nbsp;</td>
                    <td class="auto-style4">
                        <asp:Button ID="btnGuardar" runat="server" class="btn btn-primary" OnClick="btnGuardar_Click" Text="Modificar" Width="142px" />
