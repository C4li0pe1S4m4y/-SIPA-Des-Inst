                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        <table style="width:80%;">
                            ...
                            <tr>
                                <td class="auto-style11">&nbsp;</td>
                                <td class="auto-style12" colspan="2"><span><asp:Label ID="lblError" runat="server" Font-Size="Medium" Font-Bold="True" ForeColor="Red" ></asp:Label></span>
                    <span><asp:Label ID="lblSuccess" runat="server" Font-Size="Medium" Font-Bold="True" ForeColor="Green" ></asp:Label></span> </td>
                            </tr>
                            <tr>
                                <td class="auto-style11">&nbsp;</td>
                                <td class="auto-style12" colspan="2">
                                    <asp:Button ID="Button1" runat="server" class="btn btn-primary" OnClientClick=" disableButton(this)" Text="ACEPTAR" OnClick="Button1_Click" />
