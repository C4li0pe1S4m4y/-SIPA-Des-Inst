<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListadoCasos.aspx.cs" Inherits="AgendaTel.Contactos.ListadoCasos" MasterPageFile="~/Principal.Master" %>
            ...
            <table style="width:100%;">
                <tr>
                    <td style="width: 5%">
                        &nbsp;</td>
                    <td style="width: 5%">&nbsp;</td>
                    <td style="font-size: x-large; text-align: center;" class="text-center" colspan="16"><strong>LISTADO DE CASOS</strong></td>
                    ...
                    <td colspan="20">
                        <asp:GridView ID="gridEmpleados" runat="server" AllowPaging="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" CellPadding="5" CellSpacing="1" DataKeyNames="ID" ForeColor="Black" GridLines="Vertical" HorizontalAlign="Center" OnPageIndexChanging="gridEmpleados_PageIndexChanging" OnSelectedIndexChanged="gridEmpleados_SelectedIndexChanged" PageSize="100" Width="100%">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="id" HeaderText="No. Caso" Visible="true">
                                <HeaderStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                <ItemStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                </asp:BoundField>
                                <asp:BoundField DataField="nombre" HeaderText="Nombre del caso">
                                <HeaderStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                <ItemStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                </asp:BoundField>
