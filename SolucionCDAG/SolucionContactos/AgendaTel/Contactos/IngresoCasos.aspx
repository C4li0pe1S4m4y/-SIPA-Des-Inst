<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IngresoCasos.aspx.cs" Inherits="AgendaTel.Contactos.IngresoCasos" MasterPageFile="~/Principal.Master" %>
            ...
            <table style="width:100%;">
                <tr>
                    <td style="width: 5%">
                        &nbsp;</td>
                    <td style="width: 5%">&nbsp;</td>
                    <td style="font-size: x-large; text-align: center;" class="text-center" colspan="16"><strong>INGRESO DE CASOS</strong></td>
...
<tr>
                ...
                <tr>
                    ...
                    <td style="width: 5%">&nbsp;</td>
                    <td style="width: 5%">&nbsp;</td>
                    <td colspan="12">Casos existentes:<strong><asp:Label ID="lblIdCaso" runat="server" style="font-size: medium" ForeColor="White">0</asp:Label>
                        </strong></td>
                    <td style="width: 5%">&nbsp;</td>
                    <td style="width: 5%">&nbsp;</td>
                    <td style="width: 5%">&nbsp;</td>
                ...
                <tr>
                    ...
                    <td style="width: 5%">&nbsp;</td>
                    <td colspan="12">
                        <asp:DropDownList ID="ddlCasos" runat="server" AutoPostBack="True" class="form-control" Width="100%" OnSelectedIndexChanged="ddlCasos_SelectedIndexChanged">
                        </asp:DropDownList>
                    </td>
                    <td style="width: 5%">&nbsp;</td>
                    <td style="width: 5%">&nbsp;</td>
                ...
                <tr>
                    ...
                    <td style="width: 5%">&nbsp;</td>
                    <td style="width: 5%">&nbsp;</td>
                    <td colspan="12">Nombre del Caso:&nbsp;<strong><asp:Label ID="lblErrorNombreCaso" runat="server" ForeColor="Red" style="font-size: medium">*</asp:Label>
                        </strong></td>
                    <td style="width: 5%">&nbsp;</td>
                    <td style="width: 5%">&nbsp;</td>
                    <td style="width: 5%">&nbsp;</td>
                ...
                <tr>
                    ...
                    <td style="width: 5%">&nbsp;</td>
                    <td style="width: 5%">&nbsp;</td>
                    <td colspan="12">Tipos de casos:<strong><asp:Label ID="lblErrorTipoCaso" runat="server" ForeColor="Red" style="font-size: medium">*</asp:Label>
                        </strong></td>
                    <td style="width: 5%">&nbsp;</td>
                    <td style="width: 5%">&nbsp;</td>
                    <td style="width: 5%">&nbsp;</td>
                ...
                <tr>
                    ...
                    <td style="width: 5%">&nbsp;</td>
                    <td colspan="12">
                        <asp:TextBox ID="txtDescripcion" runat="server" class="form-control" Enabled="true" Height="50px" MaxLength="1000" placeholder="" TextMode="MultiLine" Width="100%"></asp:TextBox>
                    </td>
                    <td style="width: 5%">&nbsp;</td>
                    <td style="width: 5%">&nbsp;</td>
                    <td style="width: 5%">&nbsp;</td>
                ...
                <tr>
                    ...
                    <td style="width: 5%">&nbsp;</td>
                    <td style="width: 5%">&nbsp;</td>
                    <td colspan="4" style="width: 5%">Fecha de apertura (Ej: 20/01/2000):</td>
                    <td colspan="4">&nbsp;</td>
                ...
                <tr>
                    ...
                    <td colspan="16" style="text-align: center;">
                        ...
                        <asp:Button ID="btnListado" runat="server" CausesValidation="False" class="btn btn-primary" PostBackUrl="~/Contactos/ListadoCasos.aspx" Text="Ver Listado" Width="120px" />
                ...
                <tr>
                    ...
                    <td style="width: 5%">&nbsp;</td>
                    <td style="width: 5%">&nbsp;</td>
                    <td colspan="12">Adjuntos del caso:</td>
                    <td style="width: 5%">&nbsp;</td>
                    <td style="width: 5%">&nbsp;</td>
                    <td style="width: 5%">&nbsp;</td>
                    <td style="width: 5%">&nbsp;</td>
                ...
                <tr>
                    ...
                    <td style="width: 5%">&nbsp;</td>
                    <td style="width: 5%">&nbsp;</td>
                    <td colspan="3">Nombre del adjunto:</td>
                    <td colspan="9">
                        <asp:TextBox ID="txtNombreAdjunto" runat="server" BackColor="#FFFF99" class="form-control" Enabled="true" MaxLength="500" placeholder="" Width="100%"></asp:TextBox>
                    </td>
                    <td style="width: 5%">&nbsp;</td>
                    <td style="width: 5%">&nbsp;</td>
                    <td style="width: 5%">&nbsp;</td>
                ...
                <tr>
                    ...
                    <td style="width: 5%">&nbsp;</td>
                    <td style="width: 5%">&nbsp;</td>
                    <td colspan="3">Descripción del adjunto:</td>
                    <td colspan="9">
                        <asp:TextBox ID="txtDescripcionAdjunto" runat="server" class="form-control" Enabled="true" MaxLength="1000" placeholder="" TextMode="MultiLine" Width="100%"></asp:TextBox>
                    </td>
                    <td style="width: 5%">&nbsp;</td>
                    <td style="width: 5%">&nbsp;</td>
                    <td style="width: 5%">&nbsp;</td>
                ...
                <tr>
                    ...
                    <td style="width: 5%">&nbsp;</td>
                    <td style="width: 5%">&nbsp;</td>
                    <td colspan="3">Ruta del archivo:</td>
                    <td colspan="9">
                        <asp:FileUpload ID="fuArchivos" runat="server" BackColor="#FFFF99"/>
                    </td>
                    <td style="width: 5%">&nbsp;</td>
                    <td style="width: 5%">&nbsp;</td>
                    <td style="width: 5%">&nbsp;</td>
                ...
                <tr>
                    ...
                    <td style="text-align: center;" colspan="12">
                        <asp:Button ID="btnSubir" runat="server" class="btn btn-primary" Text="Subir" ValidationGroup="grpDatos" Width="120px" />
                    </td>
                    <td style="width: 5%">&nbsp;</td>
                    <td style="width: 5%">&nbsp;</td>
                    <td style="width: 5%">&nbsp;</td>
