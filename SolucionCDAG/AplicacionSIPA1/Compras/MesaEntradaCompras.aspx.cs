...
{
    public partial class MesaEntradaCompras : System.Web.UI.Page
    {
                    ...
                    //if (idPoa > 0)
                    {
                        ...
                        if (dsResultado.Tables["BUSQUEDA"].Rows.Count > 0 && dsResultado.Tables["BUSQUEDA"].Rows[0]["ID"].ToString() != "")
                        {
                            ...
                            if (dvPedido.SelectedValue != null)
                            {
                                ...
                                {
                                    string jScript = "javascript:window.open('ETVoBoN1.aspx?No=" + dvPedido.SelectedValue.ToString() + "&OptB=true&TipoD=" + tipoDocumento + "', '_blank');";
