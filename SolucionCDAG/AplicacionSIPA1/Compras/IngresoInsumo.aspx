                    ...
                    <div class="row">
                        <div>
                            <div class="col-xs-2">
                                ...
                                <asp:TextBox ID="txtPresentacion" runat="server" required="true" CssClass="form-control"></asp:TextBox>
                            </div>
                            <div class="col-xs-2">
                                <label>Cantidad Insumo:</label>
                                <asp:TextBox ID="txtCantidadInusmo" runat="server" required="true" CssClass="form-control"></asp:TextBox>
                            </div>
                            <div class="col-xs-2">
                                <label>Codigo Presentacion:</label>
                                <asp:TextBox ID="txtCodigoPresentacion" runat="server" required="true" TextMode="Number" CssClass="form-control"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                    <div class="row">
