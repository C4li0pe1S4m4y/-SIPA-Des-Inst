...
{
    public partial class CuadroAdjudicacion : System.Web.UI.Page
    {
        ...
        protected void filtrarGridDetalles()
        {
            try
            {
                ...
                pInsumoLN = new PedidosLN();
                pInsumoLN.DdlProveedores(ddlProveedores, 1);
        ...
        protected void filtrarGridCriterios()
        {
            try
            {
                ...
                tipoSalida = 4;
                pInsumoLN = new PedidosLN();
                DataSet dsResultado = pInsumoLN.InformacionCriteriosCompra(idSalida, 0, "", 1);
        ...
        protected void btnAprobar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int idSalida, idTipoSalida, idCriterio;
                idSalida = idTipoSalida = idCriterio = 0;
                if (dvPedido.SelectedValue != null)
                    int.TryParse(dvPedido.SelectedValue.ToString(), out idSalida);
                ...
                if (validarControlesABC() == true)
                {
                    ...
                    DataSet dsResultado = pInsumoLN.AlmacenarCriterio(idCriterio, 0, 0, "", decimal.Parse("0"), 0, usuario, 1);
