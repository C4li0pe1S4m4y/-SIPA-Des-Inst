    ...
    public partial class IngresarPac : System.Web.UI.Page
    {
        ...
        protected bool validarPoaIngresoPac(int idUnidad, int anio)
        {
            ...
            try
            {
                ...
                //if (int.Parse(estadoPac.Equals("1")) >= 1 || )
                ...
                {
                    lblErrorPac.Text = lblError.Text = /*lblCErrorPac.Text = lblCError.Text =*/ "El PLAN ANUAL DE COMPRAS seleccionado se encuenta en estado: " + lblEstadoPac.Text + ", por: " + observacionesPac + "";
        ...
        protected void btnModificar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (idPac > 0)
                {
                    ...
                    item = ddlModalidades.Items.FindByValue(idModalidad.ToString());
                    if (item != null)
                    ...
                    item = ddlExcepciones.Items.FindByValue(idExcepcion.ToString());
