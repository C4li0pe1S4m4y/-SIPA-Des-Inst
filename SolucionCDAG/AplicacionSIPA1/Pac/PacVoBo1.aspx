<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PacVoBo1.aspx.cs" Inherits="AplicacionSIPA1.Pac.PacVoBo1" MasterPageFile="~/Principal.Master" %>
        ...
        <ContentTemplate>
            ...
            <table style="width:100%;">
                <tr>
                    <td style="width: 5%">&nbsp;</td>
                    <td style="width: 5%">&nbsp;</td>
                    <td style="font-size: x-large; text-align: center;" class="text-center" colspan="16"><strong>VoBo SUBGERENCIA - PLAN ANUAL DE COMPRAS</strong></td>
                ...
                <tr>
                    ...
                    <td>
                        &nbsp;</td>
                    <td colspan="9">Dependencia:<strong><asp:Label ID="Label1" runat="server" ForeColor="Red" style="font-size: medium"></asp:Label>
                        </strong></td>
                    <td colspan="3">
                        Jefatura/Unidad:<strong><asp:Label ID="Label2" runat="server" ForeColor="Red" style="font-size: medium"></asp:Label>
                        </strong>
                    </td>
            ...
            <asp:UpdatePanel ID="upConsulta" runat="server">
                <ContentTemplate>
                   <table style="width: 100%;">
                            <tr>
                                <td style="width: 5%">&nbsp;</td>
                                <td colspan="18"style="font-size: x-large; text-align: center;" class="text-center"><strong>VoBo SUBGERENCIA - PLAN ANUAL DE COMPRAS</strong></td>
                       ...
                       <tr>
                            ...
                            <tr>
                                ...
                                <td colspan="18" style="text-align: center">
                                    <asp:Button ID="btnAprobar" runat="server" class="btn btn-success" OnClick="btnAprobar_Click" Text="Aprobar" Width="120px" CausesValidation="False" />
