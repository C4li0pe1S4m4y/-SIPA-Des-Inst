<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminPac.aspx.cs" Inherits="AplicacionSIPA1.Pac.AdminPac" MasterPageFile="~/Principal.Master" %>
        ...
        <ContentTemplate>
            ...
            <table style="width:100%;">
                <tr>
                    <td style="width: 5%">&nbsp;</td>
                    <td style="width: 5%">&nbsp;</td>
                    <td style="font-size: x-large; text-align: center;" class="text-center" colspan="16"><strong>INGRESO - PLAN ANUAL DE COMPRAS<br /> (ADMINISTRACIÓN)</strong></td>
            ...
            <asp:UpdatePanel ID="upConsulta" runat="server">
                <ContentTemplate>
                   <table style="width: 100%;">
                            <tr>
                                <td style="width: 5%">&nbsp;</td>
                                <td colspan="18"style="font-size: x-large; text-align: center;" class="text-center"><strong>LISTADO - PLAN ANUAL DE COMPRAS<br /> (ADMINISTRACIÓN)</strong></td>
