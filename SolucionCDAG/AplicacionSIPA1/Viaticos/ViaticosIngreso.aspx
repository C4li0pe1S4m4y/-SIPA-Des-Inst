            ...
            <table style="width:100%;">
                ...
                <tr>
                    ...
                    <td colspan="4" class="text-right">
                        <asp:TextBox ID="txtSueldoBase" runat="server" BackColor="#FFFF99" class="" Style="text-align: right" Width="95%" ReadOnly="True" ForeColor="Black" Enabled="False"></asp:TextBox>
                    </td>
                    <td style="width: 5%">&nbsp;</td>
                    <td style="width: 5%">&nbsp;</td>
                </tr>
                ...
                <tr>
                    ...
                    <td colspan="16" style="text-align: center">
                        <asp:UpdateProgress ID="UpdateProgress1" runat="server">
                            <ProgressTemplate>
                                <img alt="Cargando" class="auto-style20" longdesc="../Pedido/Imagen de Cargando" src="../img/cargar.gif" />
                            </ProgressTemplate>
                        </asp:UpdateProgress>
                    </td>
                    <td style="width: 5%">&nbsp;</td>
