<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VoBo1Jefatura.aspx.cs" Inherits="AplicacionSIPA1.Viaticos.VoBo1Jefatura" MasterPageFile="~/Principal.Master" %>
        ...
        <ContentTemplate>
            ...
            <table style="width:100%;">
                <tr>
                    ...
                    <td style="font-size: x-large; text-align: center;" class="text-center" colspan="16"><strong>Vo.Bo. JEFATURA/DIRECCIÓN - VIÁTICOS AL INTERIOR Y EXTERIOR</strong></td>
                ...
                <tr>
                    <td>
                        &nbsp;</td>
                    <td colspan="9">
                        <asp:DropDownList ID="ddlDependencias" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlDependencias_SelectedIndexChanged" class="form-control"  Width="100%">
                        </asp:DropDownList>
                    </td>
                    <td colspan="9">
                        <asp:DropDownList ID="ddl" runat="server" AutoPostBack="True" class="form-control" Width="100%">
                        </asp:DropDownList>
                    </td>
                    <td style="width: 5%">&nbsp;</td>
                </tr>
...
<tr>
                ...
                <tr>
                    ...
                    <td colspan="16" style="text-align: center;">
                        <asp:Button ID="btnAprobar" runat="server" class="btn btn-success" OnClick="btnAprobar_Click" Text="Aprobar" Width="200px" />
