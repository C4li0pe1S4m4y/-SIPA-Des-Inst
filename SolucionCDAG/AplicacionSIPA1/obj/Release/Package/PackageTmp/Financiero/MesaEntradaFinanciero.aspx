<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MesaEntradaFinanciero.aspx.cs" Inherits="AplicacionSIPA1.Financiero.MesaEntradaFinanciero" MasterPageFile="~/Principal.Master" %>
        ...
        <ContentTemplate>
            ...
            <table style="width:100%;">
                <tr>
                    ...
                    <td style="font-size: x-large; text-align: center;" class="text-center" colspan="16"><strong>MESA DE ENTRADA PARA TRANSFERENCIAS, APOYOS Y OTROS GASTOS</strong></td>
                ...
                <tr>
                    ...
                    <td colspan="10">
                        <asp:RadioButtonList ID="rblTipoDocto" runat="server" AutoPostBack="True" OnSelectedIndexChanged="btnBuscar_Click" RepeatDirection="Horizontal" Width="95%">
                            <asp:ListItem Value="3" Selected="True">Gastos</asp:ListItem>
                        </asp:RadioButtonList>
                    </td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
