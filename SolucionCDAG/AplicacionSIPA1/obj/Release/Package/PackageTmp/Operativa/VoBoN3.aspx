<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VoBoN3.aspx.cs" Inherits="AplicacionSIPA1.Operativa.VoBoN3" MasterPageFile="~/Principal.Master" %>
                    ...
                    <table style="width:100%">
                        ...
                        <tr>
                            ...
                            <td colspan="16" style="text-align: center">
                                <asp:Label ID="lblTitulo" runat="server" Font-Bold="True" Font-Size="X-Large" Text="CMI - APROBACIÓN DIRECCIÓN DE ESTRATEGIA"></asp:Label>
                                </td>
                            <td colspan="2"><strong>
                        ...
                        <tr>
                            <td style="width: 5%">&nbsp;</td>
                            <td style="width: 5%">&nbsp;</td>
                            <td colspan="8">SubDependencia:</td>
                        ...
                        <tr>
                            ...
                            <td colspan="8">
                                <asp:DropDownList ID="ddlJefaturaUnidad" runat="server" class="form-control" OnSelectedIndexChanged="ddlJefaturaUnidad_SelectedIndexChanged" AutoPostBack="True"  Width="100%">
                                </asp:DropDownList>
                            </td>
                            <td style="width: 5%">&nbsp;</td>
                            <td style="width: 5%">&nbsp;</td>
                        ...
                        <tr>
                            ...
                            <td colspan="16" style="text-align: center">
                                ...
                                <asp:Button ID="btnVerReporte" runat="server" CausesValidation="False" class="btn btn-warning" OnClick="btnVerReporte_Click" Text="Ver Reporte" Width="120px" />
