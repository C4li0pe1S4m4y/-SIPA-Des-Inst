<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PedidoMultianual.aspx.cs" Inherits="AplicacionSIPA1.Pedido.Multianuales.PedidoMultianual" MasterPageFile="~/Principal.Master" %>
        ...
        <ContentTemplate>
            ...
            <table style="width:100%;">
                <tr>
                    ...
                    <td style="font-size: x-large; text-align: center; color: #FFFFFF; background-color: #006600;" class="text-center" colspan="16"><strong>INGRESO
                        <br />
                        REQUISICIONES MULTIANUALES</strong></td>
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td colspan="2">No. Pedido:</td>
                    <td colspan="3"><strong>
                        <asp:Label ID="lblNoPedido" runat="server" style="font-size: medium">0</asp:Label>
                        </strong></td>
                    <td>&nbsp;</td>
                    <td colspan="6"><strong>
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td colspan="6">
                        <asp:DropDownList ID="ddlSolicitantes" runat="server" AutoPostBack="True" class="form-control" Width="100%" OnSelectedIndexChanged="ddlSolicitantes_SelectedIndexChanged" BackColor="#FFFF99">
                        </asp:DropDownList>
                    </td>
                    <td colspan="6">
                        <asp:DropDownList ID="ddlJefes" runat="server" AutoPostBack="True" class="form-control" Width="100%" OnSelectedIndexChanged="ddlJefes_SelectedIndexChanged" BackColor="#FFFF99">
                        </asp:DropDownList>
                    </td>
                    <td colspan="6">
                ...
                <tr>
                    ...
                    <td colspan="6">Renglón: <strong>
                        <asp:Label ID="lblRenglonPpto" runat="server" style="font-size: x-small"></asp:Label>
                        </strong></td>
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td colspan="3">Unidad de medida:</td>
                    <td colspan="3">Cantidad:</td>
                    <td colspan="4">Valor ESTIMADO INDIVIDUAL sin IVA (Q.)</td>
                    <td colspan="3">Cantidad TOTAL MULTIANUAL</td>
                    <td colspan="4">Valor MULTIANUAL Estimado INDIVIDUAL&nbsp; sin IVA (Q.)</td>
                    <td style="width: 5%">&nbsp;</td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    ...
                    <td colspan="3">
                        <asp:TextBox ID="txtCantidad" runat="server" BackColor="#FFFF99" class="form-control" Font-Size="Large" MaxLength="10" Style="text-align: right" Width="100%" required="true"></asp:TextBox>
                    </td>
                    <td colspan="4">
                        <asp:TextBox ID="txtCosto" runat="server" BackColor="#FFFF99" class="form-control" Font-Size="Large" MaxLength="12" Style="text-align: right" Width="100%" required="true"></asp:TextBox>
                    </td>
                    <td colspan="3">
                        <asp:TextBox ID="txtCantidadMultianual" runat="server" BackColor="#FFFF99" class="form-control" Font-Size="Large" MaxLength="10" Style="text-align: right" Width="100%" required="true"></asp:TextBox>
                    </td>
                    <td colspan="4">
                        <asp:TextBox ID="txtCostoMultianual" runat="server" BackColor="#FFFF99" class="form-control" Font-Size="Large" MaxLength="12" Style="text-align: right" Width="100%" required="true"></asp:TextBox>
                    </td>
                    <td style="width: 5%">&nbsp;</td>
                </tr>
                <tr>
                    ...
                    <td>&nbsp;</td>
                    <td colspan="3"><strong>
                        <asp:Label ID="lblErrorUnidadMedida" runat="server" ForeColor="Red" style="font-size: medium">*</asp:Label>
                        </strong></td>
                    <td colspan="3"><strong>
                    ...
                    <td colspan="3"><strong>
                        <asp:Label ID="lblErrorCantidadMultianual" runat="server" ForeColor="Red" style="font-size: medium">*</asp:Label>
                        </strong></td>
                    <td colspan="4"><strong>
                        <asp:Label ID="lblErrorMontoMultianual" runat="server" ForeColor="Red" style="font-size: medium">*</asp:Label>
                        </strong></td>
                    <td style="width: 5%">&nbsp;</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td colspan="16" style="text-align: center">
                        <asp:LinkButton ID="btnGuardar" runat="server" class="btn btn-primary" OnClick="btnGuardar_Click" OnClientClick="javascript:if(!confirm('¿Desea GUARDAR este registro?'))return false" Text="Guardar" ValidationGroup="grpDatos" Width="120px" />
