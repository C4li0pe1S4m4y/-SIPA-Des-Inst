<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ValeListado.aspx.cs" Inherits="AplicacionSIPA1.Pedido.ValeListado" MasterPageFile="~/Principal.Master" %>
                ...
                <ContentTemplate>
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td style="font-size: x-large; text-align: center;" class="text-center" colspan="16"><strong>LISTADO - VALES</strong></td>
                            ...
                            <td colspan="18">
                                <asp:GridView ID="gridDet" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" CellPadding="5" CellSpacing="1" DataKeyNames="ID" ForeColor="Black" GridLines="Vertical" HorizontalAlign="Center" PageSize="12" Width="100%" Font-Size="X-Small"
                                    ...
                                    <asp:LinkButton ID="btnImprimirr" runat="server" OnClick="btnImprimir_Click"><asp:Image ImageUrl="~/img/24_bits/download_page.png" runat="server" /></asp:LinkButton>
                                        ...
                                        <asp:BoundField DataField="fecha_vale" HeaderText="Fecha Vale">
                                            <HeaderStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                            <ItemStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                        </asp:BoundField>
                                        ...
                                        <asp:BoundField DataField="estado_vale" HeaderText="Estado Vale">
                                            <HeaderStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                            <ItemStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                        </asp:BoundField>
                                        <asp:TemplateField HeaderText="Total Vale">
                                            <EditItemTemplate>
