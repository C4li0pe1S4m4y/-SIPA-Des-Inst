<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListadoModTechos.aspx.cs" Inherits="AplicacionSIPA1.Presupuesto.ListadoModTechos" MasterPageFile="~/Principal.Master" %>
                ...
                <ContentTemplate>
                    ...
                    <table style="width:100%;">
                        <tr>
                            <td style="width: 5%">&nbsp;</td>
                            <td style="width: 5%">&nbsp;</td>
                            <td colspan="16" style="font-size: x-large; text-align: center"><strong>LISTADO DE MODIFICACIONES DE
                                <br />
                                TECHOS PRESUPUESTARIOS</strong></td>
                            <td style="width: 5%">&nbsp;</td>
                            <td style="width: 5%">&nbsp;</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td style="width: 5%">&nbsp;</td>
                            <td colspan="18">
                                <asp:GridView ID="gridReportes" runat="server" OnRowDataBound="gridReportes_RowDataBound" OnSelectedIndexChanged="gridReportes_SelectedIndexChanged" Width="100%" CssClass="table table-hover table-responsive">
