<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="VoBoTesoreria.aspx.cs" Inherits="AplicacionSIPA1.Pedido.VoBoTesoreria" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    <h3 style="text-align: center">VoBo Tesoreria</h3>
    <div class="row">
        <div class="col-sm-10">
    ...
    <div class="row">
        ...
        <div class="col-sm-2">
            ...
            <asp:LinkButton ID="btnAprobar" runat="server" Text="Guardar" OnClick="btnAprobar_Click"  CssClass="btn btn-success" Width="100%" Height="60%">
                Pagar&nbsp<span class="glyphicon glyphicon-ok-sign" aria-hidden="true"></span>
            </asp:LinkButton>
            <br />
        </div>
        <div class="col-sm-2">
