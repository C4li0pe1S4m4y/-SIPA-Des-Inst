<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="VoBoCoordinadorCompras.aspx.cs" Inherits="AplicacionSIPA1.Pedido.VoBoCoordinadorCompras" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    <h3 style="text-align: center">VoBo Centro de Costo</h3>
    <div class="row">
        <div class="col-sm-10">
    ...
    <div class="row">
        <div class="col-sm-1">
            ...
            <asp:Label ID="lblErrorPoa" runat="server" ForeColor="Red" Style="font-size: medium" Visible="false"></asp:Label>
        </div>
        <div class="col-sm-1">
            <label>Año</label>
        ...
        <div class="col-sm-1">
            ...
            <asp:TextBox ID="txtNo" runat="server" BackColor="#FFFF99" class="form-control" Font-Bold="True" Font-Size="Large" MaxLength="5" Style="text-align: right" Width="91%" Visible="true"></asp:TextBox>
        </div>
        <div class="col-sm-1">
            <br />
            ...
            <asp:DetailsView ID="dvPedido" runat="server" AllowPaging="True" AutoGenerateRows="False" OnPageIndexChanging="dvPedido_PageIndexChanging" DataKeyNames="ID" Width="100%"
                ...
                <Fields>
                    ...
                    <asp:TemplateField HeaderText="Anexos">
                        <ItemTemplate>
                            <asp:LinkButton ID="LinkButton1" Enabled="false" runat="server" NavigateUrl="" Text='<%# Eval("tipo_anexo") %>'></asp:LinkButton>
                        </ItemTemplate>
                        <HeaderStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                        <ItemStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                    </asp:TemplateField>
    ...
    <div class="row">
        ...
        <div class="col-sm-2">
            ...
            <asp:LinkButton ID="btnAprobar" runat="server" Text="Guardar" OnClick="btnAprobar_Click" CssClass="btn btn-success" Width="100%" Height="60%">
                Aprobar&nbsp<span class="glyphicon glyphicon-ok-sign" aria-hidden="true"></span>
            </asp:LinkButton>
            <br />
        </div>
        <div class="col-sm-2">
