<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AjusteIngreso.aspx.cs" Inherits="AplicacionSIPA1.Pedido.Ajustes.AjusteIngreso" MasterPageFile="~/Principal.Master" %>
        ...
        <ContentTemplate>
            ...
            <table style="width:100%;">
                <tr>
                    ...
                    <td style="font-size: x-large; text-align: center; color: #FFFFFF; background-color: #006600;" class="text-center" colspan="16"><strong>INGRESO - AJUSTE DE REQUISICIONES</strong></td>
                ...
                <tr>
                    <td>
                        &nbsp;</td>
                    <td colspan="9">
                        <asp:DropDownList ID="ddlDependencias" runat="server" OnSelectedIndexChanged="ddlDependencias_SelectedIndexChanged" AutoPostBack="True" class="form-control"  Width="100%">
                        </asp:DropDownList>
                    </td>
                    <td colspan="9">
                        <asp:DropDownList ID="ddlJefaturaUnidades" runat="server" OnSelectedIndexChanged="ddlJefaturaUnidades_SelectedIndexChanged" AutoPostBack="True" class="form-control"  Width="100%">
                        </asp:DropDownList>
                    </td>
                    <td style="width: 5%">&nbsp;</td>
                </tr>
                ...
                <tr>
                    <td style="width: 5%">&nbsp;</td>
                    <td colspan="18"><strong>*Las únicas requisiciones ajustables son las que se encuentran en estado 10 - Realizando gestión de compra</strong></td>
                    <td style="width: 5%">&nbsp;</td>
                </tr>
                <tr>
                    <td style="width: 5%">&nbsp;</td>
                    <td colspan="9">No. Requisición:&nbsp;</td>
                    <td colspan="9">&nbsp;</td>
                    <td style="width: 5%">&nbsp;</td>
                </tr>
                <tr>
                    <td style="width: 5%">&nbsp;</td>
                    <td colspan="9">
                        <asp:DropDownList ID="ddlNoDocumento" runat="server" AutoPostBack="True" class="form-control" OnSelectedIndexChanged="ddlNoDocumento_SelectedIndexChanged" Width="100%">
                        </asp:DropDownList>
                    </td>
                    <td colspan="9">
                ...
                <tr>
                    <td style="width: 5%">&nbsp;</td>
                    <td colspan="9">Ajustes ya existentes para el pedido seleccionado:<strong><asp:Label ID="lblNoAjuste" runat="server" style="font-size: medium" ForeColor="White">0</asp:Label>
                        <asp:Label ID="lblIdAjuste" runat="server" ForeColor="White" style="font-size: medium">0</asp:Label>
                        </strong></td>
                    <td class="text-left" colspan="9">Estado del ajuste:</td>
                    <td style="width: 5%">&nbsp;</td>
                </tr>
                <tr>
                    <td style="width: 5%">&nbsp;</td>
                        ...
                        <asp:GridView ID="gridDet" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" CellPadding="5" CellSpacing="1" DataKeyNames="ID_AJUSTE_PEDIDO_DET,ID_PEDIDO_DETALLE,ID_DETALLE_ACCION,ID_PAC" Font-Size="XX-Small" ForeColor="Black" GridLines="Vertical" HorizontalAlign="Center" PageSize="12" ShowFooter="True" Width="100%"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="MONTO AJUSTE">
                                    ...
                                    <ItemTemplate>
                                        <div class="text-right">
                                            <asp:TextBox ID="txtMontoAjuste" runat="server" Text='<%# Bind("monto_ajuste") %>' BackColor="#FFFF99" class="form-control" Font-Size="Large" MaxLength="10" Style="text-align: right" Width="100%"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td colspan="16" style="text-align: center">
                        ...
                        <asp:Button ID="btnListado" runat="server" CausesValidation="False" class="btn btn-info" OnClick="btnListado_Click"  Text="Ver Listado" Width="120px" Visible="False" />
                        <asp:Button ID="btnImprimir" runat="server" class="btn btn-default" Text="Imprimir" Width="120px" />
                    </td>
                    <td>&nbsp;</td>
                    <td style="width: 5%">&nbsp;</td>
                </tr>
