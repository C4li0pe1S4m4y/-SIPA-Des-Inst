<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="VoBoCentroCosto.aspx.cs" Inherits="AplicacionSIPA1.Compras.VoBoCentroCosto" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-sm-1">
            ...
            <asp:TextBox ID="txtNo" runat="server" BackColor="#FFFF99" class="form-control" Font-Bold="True" Font-Size="Large" MaxLength="5" Style="text-align: right" Width="91%" Visible="false"></asp:TextBox>
        </div>
        <div class="col-sm-1">
            <br />
