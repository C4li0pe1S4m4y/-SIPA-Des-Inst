...
{
    public partial class Previsado : System.Web.UI.Page
    {
        ...
        public void NuevoEncabezadoPoa()
        {
            try
            {
                ...
                rblEstadosPedido.SelectedValue = "12";
        ...
        protected void btnAprobar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (validarEstadoPedido(idPedido))
                {
                    ...
                    DataSet dsResultado = pInsumoLN.AprobacionPreorden(idPedido, idTipoDocumento, observaciones,txtPreorden.Text, usuario, ip[0], ip[1], ip[2]);
        ...
        protected void btnRechazar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    string[] solicitanteTemp = solicitandte.Split('-');
                    string[] jefeTemp = jefe.Split('-');
                    DataSet dsResultado = pInsumoLN.RechazoPreorden(idPedido, idTipoDocumento, observaciones, usuario, ip[0], ip[1], ip[2]);
