<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GastoListado.aspx.cs" Inherits="AplicacionSIPA1.Pedido.GastoListado" MasterPageFile="~/Principal.Master" %>
        ...
        <ContentTemplate>
            ...
            <table style="width:100%;">
                <tr>
                    ...
                    <td style="font-size: x-large; text-align: center;" class="text-center" colspan="16"><strong>LISTADO - INGRESO - TRANSFERENCIAS, APOYOS A FEDERACIONES Y OTROS GASTOS</strong></td>
                    ...
                    <td colspan="18">
                        <asp:GridView ID="gridDet" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" CellPadding="5" CellSpacing="1" DataKeyNames="ID" ForeColor="Black" GridLines="Vertical" HorizontalAlign="Center" OnSelectedIndexChanged="gridDet_SelectedIndexChanged" PageSize="12" Width="100%" Font-Size="X-Small"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="fecha_gasto" HeaderText="Fecha Gasto">
                                <HeaderStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                <ItemStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                </asp:BoundField>
                                ...
                                <asp:BoundField DataField="estado_gasto" HeaderText="Estado Gasto">
                                <HeaderStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                <ItemStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                </asp:BoundField>
