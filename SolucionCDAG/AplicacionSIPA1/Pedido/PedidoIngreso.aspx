<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PedidoIngreso.aspx.cs" Inherits="AplicacionSIPA1.Pedido.PedidoIngreso" MasterPageFile="~/Principal.Master" %>
                ...
                <ContentTemplate>
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td style="font-size: x-large; text-align: center; color: #FFFFFF; background-color: #006600;" class="text-center" colspan="16"><strong>INGRESO - REQUISICIONES</strong></td>
                        ...
                        <tr>
                            ...
                            <td>&nbsp;</td>
                            <td colspan="3">
                                <asp:TextBox ID="txtUnidadesMedida" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox>
                            </td>
                            <td colspan="3">
                            ...
                            <td colspan="16">
                                <asp:GridView ID="gridDet" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" CellPadding="5" CellSpacing="1" DataKeyNames="ID,NUMERO" ForeColor="Black" GridLines="Vertical" HorizontalAlign="Center" PageSize="12" ShowFooter="True" Width="100%" OnRowDeleting="gridDet_RowDeleting" OnSelectedIndexChanged="gridDet_SelectedIndexChanged" Font-Size="XX-Small" CssClass="table  table-hover">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="codigo_insumo" HeaderText="Codigo Insumo">
                                            <HeaderStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                            <ItemStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="codigo_presentacion" HeaderText="Codigo Presentacion">
                                            <HeaderStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                            <ItemStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                        </asp:BoundField>
