<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VoBo2Encargado.aspx.cs" Inherits="AplicacionSIPA1.Pedido.VoBo2Encargado" MasterPageFile="~/Principal.Master" %>
        ...
        <ContentTemplate>
            ...
            <table style="width:100%;">
                <tr>
                    ...
                    <td style="font-size: x-large; text-align: center;" class="text-center" colspan="16"><strong>Vo.Bo. SUBGERENCIA/DIRECCIÓN - REQUISICIONES, VALES Y TRANSFERENCIAS, APOYOS Y OTROS GASTOS</strong></td>
                ...
                <tr>
                    ...
                    <td>&nbsp;</td>
                    <td colspan="2">
                        <asp:TextBox ID="txtNo" runat="server" BackColor="#FFFF99" class="form-control" Font-Bold="True" Font-Size="Large" MaxLength="5" Style="text-align: right" Width="94%"></asp:TextBox>
                    </td>
                    <td colspan="3">
                ...
                <tr>
                    <td>
                        &nbsp;</td>
                    <td colspan="9">
                        <asp:DropDownList ID="ddlDependencia" runat="server"  OnSelectedIndexChanged="ddlDependencia_SelectedIndexChanged" AutoPostBack="True" class="form-control"  Width="70%" style="margin-left: 75px">
                        </asp:DropDownList>
                    </td>
                    <td colspan="9">
                        <asp:DropDownList ID="ddlJefaturaUnidad" runat="server" OnSelectedIndexChanged="ddlJefaturaUnidad_SelectedIndexChanged" AutoPostBack="True" class="form-control"  Width="70%">
                        </asp:DropDownList>
                    </td>
                    <td style="width: 5%">&nbsp;</td>
                </tr>
                ...
                <tr>
                    ...
                    <td style="height: 18px"></td>
                    <td colspan="16" style="height: 18px">Acciones:</td>
                    <td style="height: 18px"></td>
...
<tr>
                    ...
                    <td colspan="18">
                        <asp:DetailsView ID="dvPedido" runat="server" AllowPaging="True" AutoGenerateRows="False" DataKeyNames="ID,ID_ACCION" OnPageIndexChanging="dvPedido_PageIndexChanging" Width="100%"
                            ...
                            <Fields>
                                ...
                                <asp:BoundField DataField="estado_pedido" HeaderText="Estado de la Req./Vale/Gasto">
                                <HeaderStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                <ItemStyle BackColor="#99FF99" BorderStyle="Inset" Font-Bold="True" Font-Size="Large" HorizontalAlign="Center" VerticalAlign="Middle" />
                                </asp:BoundField>
                ...
                <tr>
                    ...
                    <td colspan="16" style="text-align: center;">
                        <asp:Button ID="btnAprobar" runat="server" class="btn btn-success" OnClick="btnAprobar_Click" Text="Revisado" Width="120px" />
