...
{
    public partial class VoBoCentroCosto : System.Web.UI.Page
    {
        ...
        protected void btnAprobar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (validarEstadoPedido(idPedido))
                {
                    ...
                    DataSet dsResultado = pInsumoLN.AprobacionCentroCosto(idPedido, idTipoDocumento, observaciones, usuario, ip[0], ip[1], ip[2]);
        ...
        protected void btnRechazar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    string[] solicitanteTemp = solicitandte.Split('-');
                    string[] jefeTemp = jefe.Split('-');
                    DataSet dsResultado = pInsumoLN.RechazoCentroCostos(idPedido, idTipoDocumento, observaciones, usuario, ip[0], ip[1], ip[2]);
