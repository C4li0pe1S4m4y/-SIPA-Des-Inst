<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VoBo3Ppto.aspx.cs" Inherits="AplicacionSIPA1.Pedido.VoBo3Ppto" MasterPageFile="~/Principal.Master" %>
                ...
                <ContentTemplate>
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td style="font-size: x-large; text-align: center;" class="text-center" colspan="16"><strong>Vo.Bo. PRESUPUESTO - REQUISICIONES, VALES Y TRANSFERENCIAS, APOYOS Y OTROS GASTOS</strong></td>
