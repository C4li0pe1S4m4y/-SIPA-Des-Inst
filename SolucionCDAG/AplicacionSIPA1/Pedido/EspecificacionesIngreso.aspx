<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EspecificacionesIngreso.aspx.cs" Inherits="AplicacionSIPA1.Pedido.EspecificacionesIngreso" MasterPageFile="~/Principal.Master" %>
        ...
        <ContentTemplate>
            ...
            <table style="width:100%;">
                <tr>
                    ...
                    <td style="font-size: x-large; text-align: center; color: #FFFFFF; background-color: #006600;" class="text-center" colspan="16"><strong>ESPECIFICACIONES TÉCNICAS</strong></td>
