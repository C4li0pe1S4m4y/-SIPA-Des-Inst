<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SaldosRenglones.aspx.cs" Inherits="AplicacionSIPA1.ReporteriaSistema.SaldosRenglones" MasterPageFile="~/Principal.Master" %>
        ...
        <ContentTemplate>
            ...
            <table style="width:100%;">
                <tr>
                    ...
                    <td style="font-size: x-large; text-align: center; color: #FFFFFF; background-color: #006600;" class="text-center" colspan="16"><strong>CONSULTA DE RENGLONES PRESUPUESTARIOS</strong></td>
...
<asp:Content ID="Content3" runat="server" contentplaceholderid="ContentPlaceHolder2">
    <asp:LinkButton ID="lbExportar" runat="server" Font-Bold="True" Font-Size="Large" OnClick="btnNuevo_Click">Exportar a Excel</asp:LinkButton>
</asp:Content>
