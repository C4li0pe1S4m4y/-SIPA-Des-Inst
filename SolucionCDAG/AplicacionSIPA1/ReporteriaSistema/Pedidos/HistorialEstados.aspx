<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HistorialEstados.aspx.cs" Inherits="AplicacionSIPA1.ReporteriaSistema.Pedidos.HistorialEstados" MasterPageFile="~/Principal.Master" %>
        ...
        <ContentTemplate>
            ...
            <table style="width:100%;">
                <tr>
                    ...
                    <td style="font-size: x-large; text-align: center; color: #FFFFFF; background-color: #006600;" class="text-center" colspan="16"><strong>CONSULTA DE HISTORIAL DE ESTADOS
                        <br />
                        REQUISICIONES, VALES, TRANSFERENCIAS/GASTOS Y VIÁTICOS</strong></td>
                ...
                <tr>
                    ...
                    <td style="width: 5%">&nbsp;</td>
                    <td colspan="2">
                        <asp:DropDownList ID="ddlAnios" runat="server" AutoPostBack="True" class="form-control" OnSelectedIndexChanged="ddlAnios_SelectedIndexChanged" Width="75%">
                        </asp:DropDownList>
                    </td>
                    <td colspan="6">
                ...
                <tr>
                    <td style="width: 5%">&nbsp;</td>
                    <td style="width: 5%">&nbsp;</td>
                    <td colspan="4">Números de documento:</td>
                    <td colspan="8">&nbsp;</td>
                    <td style="width: 5%">&nbsp;</td>
                    <td style="width: 5%">&nbsp;</td>
                </tr>
                <tr>
                    ...
                    <td colspan="8">
                        <asp:DropDownList ID="ddlRenglones" runat="server" AutoPostBack="True" class="form-control" OnSelectedIndexChanged="ddlRenglones_SelectedIndexChanged" Width="100%" Visible="False">
                        </asp:DropDownList>
                    </td>
                    <td style="width: 5%">&nbsp;</td>
                    <td style="width: 5%">&nbsp;</td>
                ...
                <tr>
                    <td style="width: 5%">&nbsp;</td>
                    <td colspan="18">
                        <asp:GridView ID="gridReportes" runat="server" OnSelectedIndexChanged="gridReportes_SelectedIndexChanged" Width="100%">
