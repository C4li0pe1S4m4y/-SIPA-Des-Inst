            ...
            <asp:UpdatePanel ID="upIngreso" runat="server">
                <ContentTemplate>
                    <table style="width: 100%;">
                        ...
                        <tr>
                            <td>&nbsp;</td>
                            <td colspan="9">Dependencia:<strong>
                            </strong></td>
                            <td colspan="3">Jefatura:<strong>
                            </strong></td>
                            <td class="text-right" colspan="6">&nbsp;</td>
                            <td style="width: 5%">&nbsp;</td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
                            <td colspan="9">
                                <asp:DropDownList ID="ddlDependencia" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlDependencia_SelectedIndexChanged" class="form-control"  Width="100%">
                                </asp:DropDownList>
                            </td>
                            <td colspan="9">
                                ...
                                <asp:GridView ID="gridDet" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" CellPadding="5" CellSpacing="1" DataKeyNames="ID_SEGUIMIENTO_CMI,ID_SEGUIMIENTO_CMI_DET,ID_ACCION,PPTO_ANUAL,AVANCE_PPTO_CUATRIMESTRAL,AVANCE_PPTO_ACUMULADO,SALDO,DESCRIPCION,MEDIOS_VERIFICACION,AVANCE_KPI,DESCRIPCION_AVANCE_KPI,OBSERVACIONES_DGE,PLAN_ACCION" Font-Size="Small" ForeColor="Black" GridLines="Vertical" HorizontalAlign="Center" OnSelectedIndexChanged="gridDet_SelectedIndexChanged" PageSize="12" ShowFooter="True" Width="100%">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Avance KPI (%)">
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="txtAvanceKpi" runat="server" MaxLength="6" Text='<%# Bind("avance_kpi") %>' TextMode="SingleLine" Width="50px"></asp:Label>
                                        ...
                                        <asp:TemplateField HeaderText="Descripción Avance KPI">
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="txtDescripcionAvanceKpi" runat="server" Height="100px" MaxLength="1000" Text='<%# Bind("descripcion_avance_kpi") %>' TextMode="MultiLine" Width="300px"></asp:Label>
