<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SeguimientoIngreso.aspx.cs" Inherits="AplicacionSIPA1.Operativa.Seguimiento.SeguimientoIngreso" MasterPageFile="~/Principal.Master" %>
        ...
        <ContentTemplate>
            ...
            <table style="width:100%;">
                <tr>
                    ...
                    <td style="font-size: x-large; text-align: center; color: #FFFFFF; background-color: #006600;" class="text-center" colspan="16"><strong>INGRESO - SEGUIMIENTO AL CUADRO DE MANDO INTEGRAL (CMI)</strong></td>
                ...
                <tr>
                    <td style="width: 5%">&nbsp;</td>
                    <td colspan="18">
                        <asp:CheckBoxList ID="chkFiltroColumnas" runat="server" AutoPostBack="True" Font-Size="Small" OnSelectedIndexChanged="chkFiltroColumnas_SelectedIndexChanged" RepeatDirection="Horizontal" Width="90%">
                    ...
                    <td colspan="20">
                        <asp:GridView ID="gridDet" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" CellPadding="5" CellSpacing="1" DataKeyNames="ID_SEGUIMIENTO_CMI,ID_SEGUIMIENTO_CMI_DET,ID_ACCION,PPTO_ANUAL,AVANCE_PPTO_CUATRIMESTRAL,AVANCE_PPTO_ACUMULADO,SALDO,DESCRIPCION,MEDIOS_VERIFICACION,AVANCE_KPI,DESCRIPCION_AVANCE_KPI,OBSERVACIONES_DGE,PLAN_ACCION" Font-Size="Small" ForeColor="Black" GridLines="Vertical" HorizontalAlign="Center" PageSize="12" ShowFooter="True" Width="100%" OnSelectedIndexChanged="gridDet_SelectedIndexChanged" style="margin-left: 41px"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Avance KPI (%)">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox4" runat="server"></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtAvanceKpi" runat="server" MaxLength="6" Text='<%# Bind("avance_kpi") %>' TextMode="SingleLine" Width="50px"></asp:TextBox>
                                        <asp:Label ID="lblErrorAvanceKpi" runat="server" Font-Bold="True" ForeColor="Red"></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                    <ItemStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Descripción Avance KPI">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox5" runat="server"></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtDescripcionAvanceKpi" runat="server" Height="100px" MaxLength="1000" Text='<%# Bind("descripcion_avance_kpi") %>' TextMode="MultiLine" Width="300px"></asp:TextBox>
                                        <asp:Label ID="lblErrorDescripcionAvanceKpi" runat="server" Font-Bold="True" ForeColor="Red"></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                    <ItemStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Avance Correspondiente">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtAvance" runat="server" Height="100px" MaxLength="5000" Text='<%# Bind("descripcion") %>' TextMode="MultiLine" Width="300px"></asp:TextBox>
                                        <asp:Label ID="lblErrorAvance" runat="server" Font-Bold="True" ForeColor="Red"></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                    <ItemStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Medios de verificación">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtMediosVerificacion" runat="server" Height="100px" MaxLength="5000" Text='<%# Bind("medios_verificacion") %>' TextMode="MultiLine" Width="300px"></asp:TextBox>
                                        <asp:Label ID="lblErrorMediosVerificacion" runat="server" Font-Bold="True" ForeColor="Red"></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                    <ItemStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                </asp:TemplateField>
                                <asp:BoundField DataField="ppto_anual" DataFormatString="Q {0:0,00.00}" HeaderText="Ppto. Anual">
                                <HeaderStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                <ItemStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                </asp:BoundField>
                                <asp:BoundField DataField="avance_ppto_cuatrimestral" DataFormatString="Q {0:0,00.00}" HeaderText="Av. Ppto. Cuatr.">
                                <HeaderStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                <ItemStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                </asp:BoundField>
                                <asp:BoundField DataField="avance_ppto_acumulado" DataFormatString="Q {0:0,00.00}" HeaderText="Av. Ppto. Acum.">
                                <HeaderStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                <ItemStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                </asp:BoundField>
                                <asp:BoundField DataField="saldo" DataFormatString="Q {0:0,00.00}" HeaderText="Saldo">
                                <HeaderStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                <ItemStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                </asp:BoundField>
                                <asp:BoundField DataField="observaciones_dge" HeaderText="Observaciones DGE" Visible="true">
                                <HeaderStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                <ItemStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                </asp:BoundField>
                                <asp:TemplateField HeaderText="Plan de Acción">
                                    <ItemTemplate>
                                        <asp:CheckBox ID="CheckBox1" runat="server" Checked='<%# Convert.ToBoolean(Eval("plan_accion_boolean")) %>' Enabled="false" />
                                    </ItemTemplate>
                                    <HeaderStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                    <ItemStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                </asp:TemplateField>
                                <asp:CommandField ButtonType="Image" SelectImageUrl="~/img/24_bits/save.png" ShowSelectButton="true">
                                <HeaderStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                <ItemStyle BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                                </asp:CommandField>
                            </Columns>
                ...
                <tr>
                    ...
                    <td colspan="16" style="text-align: center">
                        <asp:Button ID="btnGuardar" runat="server" class="btn btn-success" OnClick="btnGuardar_Click" Text="Guardar" ValidationGroup="grpDatos" Width="120px" Visible="False" />
                        <asp:Button ID="btnLimpiarC" runat="server" class="btn btn-warning" OnClick="btnNuevo_Click" Text="Nuevo" Width="120px" />
                        <asp:Button ID="btnListado" runat="server" CausesValidation="False" class="btn btn-info" OnClick="btnListado_Click" PostBackUrl="~/Pedido/PedidoListado.aspx" Text="Ver Listado" Width="120px" Visible="False" />
