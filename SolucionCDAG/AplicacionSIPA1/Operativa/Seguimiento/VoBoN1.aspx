<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VoBoN1.aspx.cs" Inherits="AplicacionSIPA1.Operativa.Seguimiento.VoBoN1" MasterPageFile="~/Principal.Master" %>
                ...
                <ContentTemplate>
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td style="font-size: x-large; text-align: center; color: #FFFFFF; background-color: #006600;" class="text-center" colspan="16"><strong>APROBACIÓN DE SUBGERENTE/DIRECTOR
                        <br />
                        ...
                        <tr>
                            ...
                            <tr>
                                <td colspan="20" style="overflow: scroll;">
                                    <asp:Panel runat="server" ID="panel1" Width="99%" Height="800px" ScrollBars="Vertical">
                                        <asp:GridView ID="gridDet" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" CellPadding="5" CellSpacing="1" DataKeyNames="ID_SEGUIMIENTO_CMI,ID_SEGUIMIENTO_CMI_DET,ID_ACCION,PPTO_ANUAL,AVANCE_PPTO_CUATRIMESTRAL,AVANCE_PPTO_ACUMULADO,SALDO,DESCRIPCION,MEDIOS_VERIFICACION,AVANCE_KPI,DESCRIPCION_AVANCE_KPI,OBSERVACIONES_DGE,PLAN_ACCION" Font-Size="Small" ForeColor="Black" GridLines="Vertical" HorizontalAlign="Center" PageSize="12" ShowFooter="True" Width="100%"
                                            OnRowDataBound="gridDet_RowDataBound">
