<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VoBoN3.aspx.cs" Inherits="AplicacionSIPA1.Operativa.Seguimiento.VoBoN3" MasterPageFile="~/Principal.Master" %>
        ...
        <ContentTemplate>
            ...
            <table style="width:100%;">
                <tr>
                    ...
                    <td style="font-size: x-large; text-align: center; color: #FFFFFF; background-color: #006600;" class="text-center" colspan="16"><strong>APROBACIÓN DE DIRECCIÓN DE GESTIÓN DE LA ESTRATEGIA<br />
                ...
                <tr>
                    ...
                    <td colspan="5" style="height: 27px">
                        <asp:TextBox ID="txtFechaRecepcion" runat="server" BackColor="#FFFF99" class="form-control" Font-Size="Large" Style="text-align: right" TextMode="Date" Width="97%"></asp:TextBox>
                    </td>
