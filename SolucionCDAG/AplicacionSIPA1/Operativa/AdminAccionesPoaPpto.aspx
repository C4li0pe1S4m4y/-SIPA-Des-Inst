<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminAccionesPoaPpto.aspx.cs" Inherits="AplicacionSIPA1.Operativa.AdminAccionesPoaPpto" MasterPageFile="~/Principal.Master" %>
            ...
            <asp:UpdatePanel ID="upBuscar" runat="server">
                <ContentTemplate>
                    ...
                    <table style="width: 80%;">
                        ...
                        <tr>
                            <td style="width: 178px; text-align: right;">Año:&nbsp;&nbsp;&nbsp; </td>
                ...
                <ContentTemplate>
                    ...
                    <table style="width: 100%;">
                        <tr>
                            <td style="width: 5%">&nbsp;</td>
                            <td style="width: 5%">&nbsp;</td>
                            <td colspan="16" style="font-size: x-large; text-align: center"><strong>ADMINISTRAR ACCIONES PRESUPUESTO</strong></td>
                            <td style="width: 5%">&nbsp;</td>
                            <td style="width: 5%">&nbsp;</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="width: 5%">&nbsp;</td>
                            <td colspan="8">
                                <asp:DropDownList ID="ddlDependencia" runat="server" AutoPostBack="True" class="form-control" OnSelectedIndexChanged="ddlDependen_SelectedIndexChanged" Width="100%">
                                </asp:DropDownList>
                            </td>
                            <td colspan="8">
                        ...
                        <tr>
                            ...
                            </strong></b>&nbsp;<span style="font-size: x-small"><br />
                            </span><b><span style="font-size: x-small">3er. Cuatrimestre(%)</span></b></td>
                                ...
                                <asp:Panel ID="pnlRenglones" runat="server">
                                    <table style="width: 100%;">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2" style="border: 1px solid #000000">
                                                <asp:TextBox ID="txtMonto" runat="server" Style="text-align: right" class="form-control" MaxLength="12" Width="100%"> </asp:TextBox>
                                            </td>
