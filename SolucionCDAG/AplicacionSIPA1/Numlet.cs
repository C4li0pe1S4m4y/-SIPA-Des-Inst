...
public sealed class Numlet
{
    ...
    public Numlet(Boolean ConvertirDecimales, String MascaraSalidaDecimal, String SeparadorDecimalSalida, Boolean LetraCapital)
    {
    ...
    {
        return Numlet.ToCardinal(Numero, CultureInfo.CurrentCulture);
    }
